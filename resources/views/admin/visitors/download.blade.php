		...
		<div class="d-flex justify-content-center w-100">
			<div class="card-bg w-max" id="printarea">
				<div class="card-body p-0 pb-3">
					...
					<div class="mb-3">
						@php
							echo '<img class="qr" src="data:image/png;base64,' . DNS2D::getBarcodePNG('https://china-myanmargarmentexpo2023.powerglobal.com.mm/id/'.$visitor->id, 'QRCODE',5.5,5.5) . '" alt="barcode"/>';
						@endphp
					</div>
